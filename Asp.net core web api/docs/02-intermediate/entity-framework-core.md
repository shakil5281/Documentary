...
## Learning Goal
Use EF Core as an object-relational mapper for database access.

## Simple Explanation
EF Core maps C# classes to database tables and LINQ queries to SQL.
...
## Real-world Example
Employee entities are saved to an Employees table through DbContext.
...
flowchart LR
    ...
    API --> Lesson[Entity Framework Core]
