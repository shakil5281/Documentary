...
## Learning Goal
Place business rules in services instead of controllers.

## Simple Explanation
The service layer coordinates validation, repositories, transactions, and domain decisions.
...
## Real-world Example
Payroll calculation belongs in PayrollService, not PayrollController.
