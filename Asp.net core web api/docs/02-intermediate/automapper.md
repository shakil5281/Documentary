...
## Learning Goal
Map entities and DTOs with less repetitive code.

## Simple Explanation
AutoMapper copies matching properties between object types using configured profiles.
...
## Real-world Example
Employee entity maps to EmployeeResponse DTO.
