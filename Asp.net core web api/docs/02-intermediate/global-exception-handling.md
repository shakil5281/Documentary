...
## Learning Goal
Centralize exception responses using middleware or exception handlers.

## Simple Explanation
Global handling avoids repeated try/catch blocks in every action.
...
## Real-world Example
NotFoundException becomes a 404 response everywhere.
...
flowchart LR
    ...
    API --> Lesson[Global Exception Handling]
