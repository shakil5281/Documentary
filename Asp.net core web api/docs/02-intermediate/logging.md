...
## Learning Goal
Record useful runtime information for debugging and production support.

## Simple Explanation
Structured logs explain what happened, where, and with which important context.
...
## Real-world Example
Log employee creation with employee id and request correlation id.
