...
## Learning Goal
Create and evolve database schema from C# entity classes.

## Simple Explanation
Migrations are versioned database changes generated from your model changes.
...
## Real-world Example
Adding a Salary column creates a migration and updates the database.
...
flowchart LR
    ...
    API --> Lesson[Code First Migration]
