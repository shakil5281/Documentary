...
## Simple Explanation
Repositories keep query and persistence details away from controllers and services.
...
## Real-world Example
EmployeeService calls IEmployeeRepository.GetByIdAsync instead of DbContext directly.
