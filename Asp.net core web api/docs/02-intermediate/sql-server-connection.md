...
## Learning Goal
Configure ASP.NET Core Web API to connect safely to SQL Server.

## Simple Explanation
A connection string tells EF Core where the database is and how to authenticate.
...
## Real-world Example
Development uses LocalDB while production uses a secure server connection string.
...
flowchart LR
    ...
    API --> Lesson[SQL Server Connection]
