...
## Learning Goal
Understand common layer separation in APIs.

## Simple Explanation
Layered Architecture separates presentation, business, data access, and database responsibilities.
...
flowchart LR
    ...
    API --> Lesson[Layered Architecture]
