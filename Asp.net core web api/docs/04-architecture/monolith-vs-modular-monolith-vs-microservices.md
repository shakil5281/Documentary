...
## Learning Goal
Compare architecture choices and trade-offs.

## Simple Explanation
A monolith is one deployable unit, modular monolith has internal boundaries, microservices split deployables.
...
## Real-world Example
Start Employee Management as a modular monolith before extracting Payroll.
...
flowchart LR
    ...
    API --> Lesson[Monolith vs Modular Monolith vs Microservices]
