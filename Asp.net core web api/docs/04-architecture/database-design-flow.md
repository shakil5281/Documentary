...
## Learning Goal
Design database tables from business requirements.

## Simple Explanation
Database design moves from use cases to entities, relationships, constraints, and indexes.
...
## Real-world Example
Employee belongs to Department and has many Attendance records.
...
flowchart LR
    ...
    API --> Lesson[Database Design Flow]
