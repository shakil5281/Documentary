...
## Learning Goal
Design applications where business rules are independent of frameworks.

## Simple Explanation
Clean Architecture keeps domain and application logic at the center.
