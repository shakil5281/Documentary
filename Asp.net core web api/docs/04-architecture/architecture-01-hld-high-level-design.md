# Architecture 01: HLD High Level Design

## Overview
HLD High Level Design teaches architecture thinking for ASP.NET Core Web API (.NET 10), SQL Server, Redis, RabbitMQ, Docker, Kubernetes, and enterprise systems.
...
System Context Diagram must be designed with ownership, failure handling, security, monitoring, and deployment impact in mind. Document the decision, trade-offs, and operational expectations before implementation.

### Application Components
Application Components must be designed with ownership, failure handling, security, monitoring, and deployment impact in mind. Document the decision, trade-offs, and operational expectations before implementation.

### External Integrations
External Integrations must be designed with ownership, failure handling, security, monitoring, and deployment impact in mind. Document the decision, trade-offs, and operational expectations before implementation.

### Infrastructure Overview
Infrastructure Overview must be designed with ownership, failure handling, security, monitoring, and deployment impact in mind. Document the decision, trade-offs, and operational expectations before implementation.
...
```mermaid
flowchart TD
    Need[Business Need] --> Decision[HLD High Level Design]
