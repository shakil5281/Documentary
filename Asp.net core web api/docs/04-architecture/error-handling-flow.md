...
## Learning Goal
Design consistent validation and exception responses.

## Simple Explanation
Errors should be converted into predictable HTTP responses.
...
## Real-world Example
Validation failure returns 400, missing resource returns 404, unexpected error returns 500.
...
flowchart LR
    ...
    API --> Lesson[Error Handling Flow]
