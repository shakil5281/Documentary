# Architecture 09: Event Driven Architecture

## Overview
Event Driven Architecture teaches architecture thinking for ASP.NET Core Web API (.NET 10), SQL Server, Redis, RabbitMQ, Docker, Kubernetes, and enterprise systems.
...
### Event Sourcing
Event Sourcing must be designed with ownership, failure handling, security, monitoring, and deployment impact in mind. Document the decision, trade-offs, and operational expectations before implementation.

### Domain Events
Domain Events must be designed with ownership, failure handling, security, monitoring, and deployment impact in mind. Document the decision, trade-offs, and operational expectations before implementation.

### Integration Events
Integration Events must be designed with ownership, failure handling, security, monitoring, and deployment impact in mind. Document the decision, trade-offs, and operational expectations before implementation.
...
```mermaid
flowchart TD
    Need[Business Need] --> Decision[Event Driven Architecture]
