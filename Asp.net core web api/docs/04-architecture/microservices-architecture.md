...
## Learning Goal
Understand how APIs can be split into independently deployable services.

## Simple Explanation
Microservices own their data and communicate through APIs or events.
...
## Real-world Example
Auth Service, Employee Service, and Payroll Service can deploy separately.
...
flowchart LR
    ...
    API --> Lesson[Microservices Architecture]
