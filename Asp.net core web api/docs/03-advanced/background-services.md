...
## Learning Goal
Run long-running or scheduled tasks outside request threads.

## Simple Explanation
Background services process work after the API response or on a schedule.
...
## Real-world Example
Daily attendance summary generation runs at midnight.
...
flowchart LR
    ...
    API --> Lesson[Background Services]
