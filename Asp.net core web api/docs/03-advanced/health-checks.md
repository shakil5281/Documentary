...
## Learning Goal
Expose operational health for databases, cache, and services.

## Simple Explanation
Health checks tell deployment platforms whether the API is ready and alive.
...
## Real-world Example
Kubernetes checks /health before routing traffic to a pod.
