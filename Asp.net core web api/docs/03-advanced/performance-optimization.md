...
## Learning Goal
Make APIs faster, more scalable, and more efficient.

## Simple Explanation
Performance work targets database queries, serialization, caching, async IO, and payload size.
...
## Real-world Example
Use projection instead of loading full Employee graphs for list pages.
...
flowchart LR
    ...
    API --> Lesson[Performance Optimization]
