...
## Learning Goal
Use messaging for async communication between systems.

## Simple Explanation
Queues let services publish work and process it reliably later.
...
## Real-world Example
EmployeeCreated event triggers email and audit processing.
...
flowchart LR
    ...
    API --> Lesson[RabbitMQ Message Queue]
