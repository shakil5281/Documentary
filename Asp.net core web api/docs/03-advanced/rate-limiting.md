...
## Learning Goal
Protect APIs from too many requests.

## Simple Explanation
Rate limiting restricts how often a client can call an endpoint.
...
## Real-world Example
Login endpoint allows only five attempts per minute per IP.
