...
## Learning Goal
Protect APIs from common security mistakes.

## Simple Explanation
Security requires validation, least privilege, HTTPS, secrets management, and careful error output.
...
## Real-world Example
JWT secret is stored in environment variables, not committed to Git.
...
flowchart LR
    ...
    API --> Lesson[Security Best Practices]
