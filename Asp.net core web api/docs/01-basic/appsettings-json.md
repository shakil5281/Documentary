...
## Learning Goal
Store configuration such as connection strings, JWT settings, and logging levels.

## Simple Explanation
appsettings.json keeps environment-specific values outside source code logic.
...
## Real-world Example
ConnectionStrings:DefaultConnection points to SQL Server in development.
