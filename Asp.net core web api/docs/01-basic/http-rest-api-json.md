...
## Learning Goal
Learn how clients and APIs communicate using HTTP verbs, RESTful resources, and JSON payloads.

## Simple Explanation
HTTP is the transport, REST is a design style, and JSON is the common data format.
...
## Real-world Example
A browser sends GET /api/employees/5 and receives a JSON employee object.
