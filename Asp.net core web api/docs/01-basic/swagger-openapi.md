...
## Learning Goal
Document and test APIs using Swagger UI and OpenAPI metadata.

## Simple Explanation
OpenAPI describes your API contract, and Swagger UI makes it readable and testable.
...
## Real-world Example
A frontend developer opens Swagger to see request bodies for Employee endpoints.
