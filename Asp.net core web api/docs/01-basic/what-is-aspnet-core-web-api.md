...
## Learning Goal
Understand what ASP.NET Core Web API is and where it fits in modern software.

## Simple Explanation
A Web API is the waiter between a frontend app and server-side business/data logic.
...
## Real-world Example
A mobile app asks an Employee API for employee profile data instead of connecting directly to SQL Server.
...
flowchart LR
    ...
    API --> Lesson[What is ASP.NET Core Web API]
