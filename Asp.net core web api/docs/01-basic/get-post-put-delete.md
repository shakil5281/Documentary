...
## Learning Goal
Understand the core HTTP methods used in CRUD APIs.

## Simple Explanation
GET reads, POST creates, PUT replaces or updates, and DELETE removes resources.
...
## Real-world Example
Employee Management uses POST to add an employee and DELETE to remove one.
...
flowchart LR
    ...
    API --> Lesson[GET, POST, PUT, DELETE]
