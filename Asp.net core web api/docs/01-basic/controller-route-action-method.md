...
## Learning Goal
Learn how controllers expose API endpoints using routes and action methods.

## Simple Explanation
A controller groups related endpoints, routes define URLs, and action methods handle requests.
...
## Real-world Example
EmployeesController contains GetById, Create, Update, and Delete actions.
...
flowchart LR
    ...
    API --> Lesson[Controller, Route, Action Method]
