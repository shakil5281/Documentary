...
## Learning Goal
Separate database models, input DTOs, and response DTOs clearly.

## Simple Explanation
Models represent internal data, DTOs represent API contracts, requests carry input, and responses carry output.
...
## Real-world Example
CreateEmployeeRequest accepts Name and DepartmentId, while EmployeeResponse returns Id, Name, DepartmentName.
...
flowchart LR
    ...
    API --> Lesson[Model, DTO, Request, Response]
