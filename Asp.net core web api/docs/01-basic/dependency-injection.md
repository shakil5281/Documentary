...
## Learning Goal
Use built-in dependency injection to keep controllers clean and testable.

## Simple Explanation
DI gives classes their dependencies instead of creating them manually inside methods.
...
## Real-world Example
EmployeesController receives IEmployeeService through its constructor.
...
flowchart LR
    ...
    API --> Lesson[Dependency Injection]
