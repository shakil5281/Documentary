...
## Simple Explanation
Middleware is a chain of components that can inspect, change, pass, or stop a request.
...
## Real-world Example
Authentication middleware validates a JWT before the controller runs.
