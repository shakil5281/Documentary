...
## Learning Goal
Return predictable, helpful API errors without leaking sensitive details.

## Simple Explanation
Good error handling converts exceptions and validation failures into consistent HTTP responses.
...
## Real-world Example
Invalid employee input returns 400 Bad Request with clear field messages.
